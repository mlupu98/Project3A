...
am_rel_srcdir='.'
am_top_srcdir='/Users/mpaterno/Desktop/111-project-3a/fuse-ext2.build/automake-1.15'
am_top_builddir='/Users/mpaterno/Desktop/111-project-3a/fuse-ext2.build/automake-1.15'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/opt/gnu/share/automake-1.15/am'
    am_automake_acdir='/opt/gnu/share/aclocal-1.15'
    am_bindir='/opt/gnu/bin'
    am_datadir='/opt/gnu/share'
    am_docdir='/opt/gnu/share/doc/automake'
    am_pkgvdatadir='/opt/gnu/share/automake-1.15'
    am_scriptdir='/opt/gnu/share/automake-1.15'
    am_system_acdir='/opt/gnu/share/aclocal'
    ;;
  no)
